...
(defn floating-screen-derived-values
  ...
  (let [screen-state (reanimated/use-shared-value
    ...
    {:screen-state   screen-state
     :screen-left    (worklets.shell/floating-screen-left screen-state width)
     ...
     ;; :screen-margin-top (worklets.shell/floating-screen-margin-top screen-state)
